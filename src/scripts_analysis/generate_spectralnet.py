...
if __name__ == '__main__':
    ...
    for image_idx in tqdm(range(len(np_files_path))):
        ...
        if not args.rerun:
            ...
            from helper_generate_spectralnet import generate_spectralnet
            dice_score, label_pred, seg_pred = generate_spectralnet(
            ...
            with open(save_path, 'wb+') as f:
                np.savez(f,
                         ...
                         label=label_true,
                         latent=latent,
                         label_spectralnet=label_pred,    # label_spectranet
                         seg_spectranet=seg_pred)
                ...
                while True:
                    try:
                        proc = subprocess.Popen([
                            'python3', folder + '/helper_generate_spectralnet.py',
                        ...
                        proc.kill()
                        # This is determined by the sys.stdout in `helper_generate_spectralnet.py`

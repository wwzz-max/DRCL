...
if __name__ == '__main__':
    ...
    for image_idx in tqdm(range(len(np_files_path))):
        ...
        if not args.rerun:
            ...
            from helper_generate_pos_spectralnet import generate_pos_spectralnet
            ...
            with open(save_path, 'wb+') as f:
                np.savez(f,
                         ...
                         label=label_true,
                         latent=latent,
                         label_pos_spectralnet=label_pred,
                         seg_pos_spectralnet=seg_pred)    # label_pos_spectralnet
                ...
                while True:
                    try:
                        proc = subprocess.Popen([
                            'python3', folder + '/helper_generate_pos_spectralnet.py',
                        ...
                        proc.kill()
                        # This is determined by the sys.stdout in `helper_generate_pos_spectralnet.py`
